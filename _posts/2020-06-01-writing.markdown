...
[Artificial Neural Networks](https://en.wikipedia.org/wiki/Artificial_neural_network) have become probably the most exciting mathematical construction in the last decade. Although firstly proposed by W. McCulloch and W. Pitts in the 40s, and later expanded by scientist like [Y. LeCun, Y. Bengio & G. Hinton](https://www.nature.com/articles/nature14539) at the turn of this century, their widespread use did not explode until an increasing computing performance, huge storage capacity and tremendous data availability took place. Computer Vision --- or how to make computers see --- has radically benefit from it to accomplish unbelievable tasks just a few years ago.
...
Regardless of evidences, to understand why writing systems emerged it could be explained in fact by the great advances they really brought, as the opening quote of this text beautifully describes.
...
I hope you enjoyed this particular story of the history of writing, an amazing and exciting legacy of the Ancient Worlds. Thanks for reading!
